...
src/
  ...
  pages/
    ...
    reading.astro                       # Tabbed year-by-year book log (2026 down to 2020, plus a trailing "2019…" tab for older/undated reads) — covers link out to Amazon; search by title/author and a "Filters" popover (icon-only on mobile, audiobooks toggle + exact-star-rating picker) both span every year, switching to a cross-year results grid; selecting a year tab clears all filters and returns to plain browsing
    rss.xml.js                          # RSS feed
