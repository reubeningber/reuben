...
src/
  ...
  pages/
    ...
    reading.astro                       # Tabbed year-by-year book log (2020-2026) — covers link out to Amazon; search by title/author and a "Filters" popover (icon-only on mobile, audiobooks toggle + exact-star-rating picker) both span every year, switching to a cross-year results grid; selecting a year tab clears all filters and returns to plain browsing
    rss.xml.js                          # RSS feed
